...
const mainSchema = new Schema({
  ...
  Content: {
    ...
    validate: {
      ...
      message:
        "Content must be either a string or an array of objects with babTitle and babContent fields.",
    },
  },
});

const mainModel: Model<Data> = models.mains || model<Data>("mains", mainSchema);
const goingModel: Model<Data> =
  models.ongoings || model<Data>("ongoings", mainSchema);
